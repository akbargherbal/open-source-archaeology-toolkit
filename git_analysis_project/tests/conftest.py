...
3. Function-scoped fixtures to provide pre-built CommitDataCache objects.
4. Mocking fixtures for external dependencies like matplotlib.
"""
...
@pytest.fixture
def empty_repo_cache(empty_repo) -> CommitDataCache:
    """Provides a pre-built CommitDataCache for an empty repository."""
    return CommitDataCache(empty_repo)
